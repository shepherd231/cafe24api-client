...
export default (cls) => {
  register(cls);
    ...
    const retrieveAListOfProductCategories = cls.prototype.retrieveAListOfProductCategories;
    ...
    const retrieveACountOfProductCategories = cls.prototype.retrieveACountOfProductCategories;
