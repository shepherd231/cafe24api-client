/**
 * @fileoverview
 * This code is originally from https://github.com/blakeembrey/change-case.
 *
 * I copy-pasted the code here as there's some issues using this package
 * in CJS environment.
 */
...
export function noCase(input, options) {
  ...
  return (
    prefix + split(input, options).map(lowerFactory(options?.locale)).join(' ')
  );
}
/**
