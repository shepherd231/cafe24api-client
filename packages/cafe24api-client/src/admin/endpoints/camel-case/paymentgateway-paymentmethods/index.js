...
export default (cls) => {
  ...
  const retrieveAListOfPaymentGatewayMethods =
    cls.prototype.retrieveAListOfPaymentGatewayMethods;
  ...
  const updateAPaymentMethodOfAPaymentGateway =
    cls.prototype.updateAPaymentMethodOfAPaymentGateway;
  ...
  const deleteAPaymentMethodOfAPaymentGateway =
    cls.prototype.deleteAPaymentMethodOfAPaymentGateway;
