...
export default (cls) => {
  register(cls);
    ...
    const retrieveAListOfProductCategoryTranslations = cls.prototype.retrieveAListOfProductCategoryTranslations;
    ...
    const updateProductCategoryTranslation = cls.prototype.updateProductCategoryTranslation;
