...
export default (cls) => {
  ...
  const retrieveAListOfProductsByCategory =
    cls.prototype.retrieveAListOfProductsByCategory;
  ...
  const retrieveACountOfProductsByCategory =
    cls.prototype.retrieveACountOfProductsByCategory;
  ...
  const updateAProductInProductCategory =
    cls.prototype.updateAProductInProductCategory;
