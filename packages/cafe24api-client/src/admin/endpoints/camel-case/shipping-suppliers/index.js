...
export default (cls) => {
  ...
  const retrieveASupplierSShippingSettings =
    cls.prototype.retrieveASupplierSShippingSettings;
  ...
  const updateASupplierSShippingSettings =
    cls.prototype.updateASupplierSShippingSettings;
