...
export default (cls) => {
  ...
  const retrieveACountOfProductsInMainCategory =
    cls.prototype.retrieveACountOfProductsInMainCategory;
  cls.prototype.retrieveACountOfProductsInMainCategory = async function (
    input,
    options,
  ) {
  ...
  const updateFixedSortingOfProductsInMainCategory =
    cls.prototype.updateFixedSortingOfProductsInMainCategory;
  cls.prototype.updateFixedSortingOfProductsInMainCategory = async function (
    input,
    options,
  ) {
  ...
  const deleteAProductInMainCategory =
    cls.prototype.deleteAProductInMainCategory;
