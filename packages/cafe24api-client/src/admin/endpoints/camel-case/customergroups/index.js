...
export default (cls) => {
  register(cls);
    ...
    const retrieveAListOfCustomerTiers = cls.prototype.retrieveAListOfCustomerTiers;
    ...
    const retrieveACountOfCustomerTiers = cls.prototype.retrieveACountOfCustomerTiers;
