...
export default (cls) => {
  register(cls);
    ...
    const retrieveAListOfStoreTranslations = cls.prototype.retrieveAListOfStoreTranslations;
    ...
    const updateTheTranslationsOfAStore = cls.prototype.updateTheTranslationsOfAStore;
