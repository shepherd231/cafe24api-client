...
export default (cls) => {
  ...
  const retrieveTheKakaoInfoTalkSettings =
    cls.prototype.retrieveTheKakaoInfoTalkSettings;
  ...
  const updateTheKakaoInfoTalkSettings =
    cls.prototype.updateTheKakaoInfoTalkSettings;
