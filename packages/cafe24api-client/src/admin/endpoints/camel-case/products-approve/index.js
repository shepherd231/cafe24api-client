...
export default (cls) => {
  ...
  const retrieveAProductApprovalStatus =
    cls.prototype.retrieveAProductApprovalStatus;
  ...
  const createAProductApprovalRequest =
    cls.prototype.createAProductApprovalRequest;
  ...
  const updateAProductApprovalStatus =
    cls.prototype.updateAProductApprovalStatus;
