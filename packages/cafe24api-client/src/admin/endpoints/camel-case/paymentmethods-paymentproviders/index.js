...
export default (cls) => {
  ...
  const retrieveAListOfProvidersByPaymentMethod =
    cls.prototype.retrieveAListOfProvidersByPaymentMethod;
  ...
  const updateTheDisplayStatusOfAPaymentMethod =
    cls.prototype.updateTheDisplayStatusOfAPaymentMethod;
