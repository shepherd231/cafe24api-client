...
export default (cls) => {
  register(cls);
    ...
    const retrieveAListOfCustomerCoupons = cls.prototype.retrieveAListOfCustomerCoupons;
    ...
    const retrieveACountOfCustomerCoupons = cls.prototype.retrieveACountOfCustomerCoupons;
