...
export default (cls) => {
  register(cls);
    ...
    const retrieveAListOfSupplierUsers = cls.prototype.retrieveAListOfSupplierUsers;
    ...
    const retrieveACountOfSupplierUsers = cls.prototype.retrieveACountOfSupplierUsers;
