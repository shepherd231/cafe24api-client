...
export default (cls) => {
  register(cls);
    ...
    const retrieveAListOfManufacturers = cls.prototype.retrieveAListOfManufacturers;
    ...
    const retrieveACountOfManufacturers = cls.prototype.retrieveACountOfManufacturers;
