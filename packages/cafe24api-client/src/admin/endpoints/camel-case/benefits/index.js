...
export default (cls) => {
  register(cls);
    ...
    const retrieveAListOfCustomerBenefits = cls.prototype.retrieveAListOfCustomerBenefits;
    ...
    const retrieveACountOfCustomerBenefits = cls.prototype.retrieveACountOfCustomerBenefits;
