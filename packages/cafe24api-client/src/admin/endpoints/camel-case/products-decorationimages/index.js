...
export default (cls) => {
  register(cls);
    ...
    const retrieveAListOfDecorationImages = cls.prototype.retrieveAListOfDecorationImages;
    ...
    const setDecorationImagesForAProduct = cls.prototype.setDecorationImagesForAProduct;
    ...
    const updateProductDecorationImages = cls.prototype.updateProductDecorationImages;
    ...
    const removeAProductDecorationImage = cls.prototype.removeAProductDecorationImage;
