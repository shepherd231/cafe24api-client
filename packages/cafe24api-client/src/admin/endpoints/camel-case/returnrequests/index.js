...
export default (cls) => {
  ...
  const createAReturnRequestForMultipleItems =
    cls.prototype.createAReturnRequestForMultipleItems;
  ...
  const rejectAReturnRequestForMultipleItems =
    cls.prototype.rejectAReturnRequestForMultipleItems;
