...
export default (cls) => {
  register(cls);
    ...
    const createACancellationRequestForMultipleItems = cls.prototype.createACancellationRequestForMultipleItems;
    ...
    const rejectACancellationRequestForMultipleItems = cls.prototype.rejectACancellationRequestForMultipleItems;
