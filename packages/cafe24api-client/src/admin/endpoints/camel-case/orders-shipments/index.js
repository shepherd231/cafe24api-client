...
export default (cls) => {
  ...
  const retrieveAListOfShippingInformationOfAnOrder =
    cls.prototype.retrieveAListOfShippingInformationOfAnOrder;
  ...
  const createAnOrderShippingInformation =
    cls.prototype.createAnOrderShippingInformation;
