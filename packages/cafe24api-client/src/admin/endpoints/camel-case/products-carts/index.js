...
export default (cls) => {
  ...
  const retrieveAListOfCartsContainingAProduct =
    cls.prototype.retrieveAListOfCartsContainingAProduct;
  cls.prototype.retrieveAListOfCartsContainingAProduct = async function (
    input,
    options,
  ) {
