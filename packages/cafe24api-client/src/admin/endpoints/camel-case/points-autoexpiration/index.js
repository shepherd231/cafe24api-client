...
export default (cls) => {
  register(cls);
    ...
    const retrieveAnAutomaticPointsExpiration = cls.prototype.retrieveAnAutomaticPointsExpiration;
    ...
    const createAnAutomaticPointsExpiration = cls.prototype.createAnAutomaticPointsExpiration;
    ...
    const deleteAnAutomaticPointsExpiration = cls.prototype.deleteAnAutomaticPointsExpiration;
