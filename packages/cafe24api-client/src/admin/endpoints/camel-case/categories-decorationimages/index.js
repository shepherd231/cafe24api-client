...
export default (cls) => {
  ...
  const retrieveDecorationImageSettingsByCategory =
    cls.prototype.retrieveDecorationImageSettingsByCategory;
  ...
  const updateDecorationImagesOfAProductCategory =
    cls.prototype.updateDecorationImagesOfAProductCategory;
