...
export default (cls) => {
  ...
  const createShippingInformationForMultipleOrders =
    cls.prototype.createShippingInformationForMultipleOrders;
  ...
  const updateMultipleOrderShippings =
    cls.prototype.updateMultipleOrderShippings;
