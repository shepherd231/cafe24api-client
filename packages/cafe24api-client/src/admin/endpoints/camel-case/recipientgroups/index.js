...
export default (cls) => {
  register(cls);
    ...
    const retrieveDistributionGroupList = cls.prototype.retrieveDistributionGroupList;
    ...
    const retrieveDistributionGroupDetails = cls.prototype.retrieveDistributionGroupDetails;
