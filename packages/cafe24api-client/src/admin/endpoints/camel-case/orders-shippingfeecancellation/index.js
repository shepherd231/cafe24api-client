...
export default (cls) => {
  register(cls);
    ...
    const retrieveShippingFeeCancellationDetailsOfAnOrder = cls.prototype.retrieveShippingFeeCancellationDetailsOfAnOrder;
    cls.prototype.retrieveShippingFeeCancellationDetailsOfAnOrder = async function (input, options) {
      const response = await retrieveShippingFeeCancellationDetailsOfAnOrder.call(
        this,
    ...
    const createAnOrderShippingFeeCancellation = cls.prototype.createAnOrderShippingFeeCancellation;
