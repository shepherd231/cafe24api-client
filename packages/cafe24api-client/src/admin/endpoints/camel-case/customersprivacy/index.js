...
export default (cls) => {
  register(cls);
    ...
    const retrieveAListOfCustomerInformation = cls.prototype.retrieveAListOfCustomerInformation;
    ...
    const retrieveACountOfCustomerInformation = cls.prototype.retrieveACountOfCustomerInformation;
    ...
    const retrieveACustomerInformation = cls.prototype.retrieveACustomerInformation;
