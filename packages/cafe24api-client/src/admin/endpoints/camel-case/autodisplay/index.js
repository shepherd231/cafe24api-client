...
export default (cls) => {
  register(cls);
    ...
    const createAutoLayoutForSelectedProductCategory = cls.prototype.createAutoLayoutForSelectedProductCategory;
    ...
    const updateAutoLayoutForSelectedProductCategory = cls.prototype.updateAutoLayoutForSelectedProductCategory;
    ...
    const deleteAutoLayoutForSelectedProductCategory = cls.prototype.deleteAutoLayoutForSelectedProductCategory;
