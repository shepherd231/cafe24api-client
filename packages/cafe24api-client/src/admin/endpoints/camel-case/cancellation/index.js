...
export default (cls) => {
  ...
  const createMultipleOrderCancellations =
    cls.prototype.createMultipleOrderCancellations;
  ...
  const changeCancellationDetailsInBulk =
    cls.prototype.changeCancellationDetailsInBulk;
