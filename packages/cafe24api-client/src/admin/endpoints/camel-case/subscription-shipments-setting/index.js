...
export default (cls) => {
  ...
  const retrieveAListOfSubscriptionProducts =
    cls.prototype.retrieveAListOfSubscriptionProducts;
  ...
  const createASubscriptionPaymentRule =
    cls.prototype.createASubscriptionPaymentRule;
