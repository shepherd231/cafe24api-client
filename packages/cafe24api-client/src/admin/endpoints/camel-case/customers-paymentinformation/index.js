...
export default (cls) => {
  register(cls);
    ...
    const retrieveACustomerSListOfPaymentMethods = cls.prototype.retrieveACustomerSListOfPaymentMethods;
    ...
    const deleteCustomerSPaymentInformation = cls.prototype.deleteCustomerSPaymentInformation;
