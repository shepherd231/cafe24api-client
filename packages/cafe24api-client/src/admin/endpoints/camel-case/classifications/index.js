...
export default (cls) => {
  ...
  const retrieveAListOfCustomCategories =
    cls.prototype.retrieveAListOfCustomCategories;
  ...
  const retrieveACountOfCustomCategories =
    cls.prototype.retrieveACountOfCustomCategories;
