...
export default (cls) => {
  register(cls);
    ...
    const retrieveACountOfCustomerMemos = cls.prototype.retrieveACountOfCustomerMemos;
    ...
    const retrieveAListOfCustomerMemos = cls.prototype.retrieveAListOfCustomerMemos;
