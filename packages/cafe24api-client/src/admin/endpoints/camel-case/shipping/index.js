...
export default (cls) => {
  register(cls);
    ...
    const retrieveShippingReturnSettings = cls.prototype.retrieveShippingReturnSettings;
    ...
    const updateStoreShippingReturnSettings = cls.prototype.updateStoreShippingReturnSettings;
