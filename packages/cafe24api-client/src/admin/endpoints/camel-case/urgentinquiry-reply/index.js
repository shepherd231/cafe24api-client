...
export default (cls) => {
  ...
  const retrieveAReplyForUrgentInquiryPost =
    cls.prototype.retrieveAReplyForUrgentInquiryPost;
  ...
  const createAReplyForUrgentInquiryPost =
    cls.prototype.createAReplyForUrgentInquiryPost;
  ...
  const updateAReplyForUrgentInquiryPost =
    cls.prototype.updateAReplyForUrgentInquiryPost;
