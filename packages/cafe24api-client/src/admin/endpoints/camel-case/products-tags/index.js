...
export default (cls) => {
  register(cls);
    ...
    const retrieveACountOfAProductSProductTags = cls.prototype.retrieveACountOfAProductSProductTags;
    ...
    const retrieveAListOfAProductSProductTags = cls.prototype.retrieveAListOfAProductSProductTags;
