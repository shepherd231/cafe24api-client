...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfOrders(
      ...
      options?: AdminRequestOptions<RetrieveAListOfOrdersOutput['orders'][number]>,
    ...
    retrieveAnOrder(
      ...
      options?: AdminRequestOptions<RetrieveAnOrderOutput['order']>,
    ...
    retrieveACountOfOrders(
      ...
      options?: AdminRequestOptions<RetrieveACountOfOrdersOutput['count']>,
    ...
    updateStatusForMultipleOrders(
      ...
      options?: AdminRequestOptions<UpdateStatusForMultipleOrdersOutput['orders'][number]>,
    ...
    updateAnOrderStatus(
      ...
      options?: AdminRequestOptions<UpdateAnOrderStatusOutput['order']>,
