...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfPaymentGatewayMethods(
      ...
      options?: AdminRequestOptions<RetrieveAListOfPaymentGatewayMethodsOutput['paymentmethods'][number]>,
    ...
    createAPaymentGatewayMethod(
      ...
      options?: AdminRequestOptions<CreateAPaymentGatewayMethodOutput['paymentmethod']>,
    ...
    updateAPaymentMethodOfAPaymentGateway(
      ...
      options?: AdminRequestOptions<UpdateAPaymentMethodOfAPaymentGatewayOutput['paymentmethod']>,
    ...
    deleteAPaymentMethodOfAPaymentGateway(
      ...
      options?: AdminRequestOptions<DeleteAPaymentMethodOfAPaymentGatewayOutput['paymentmethod']>,
