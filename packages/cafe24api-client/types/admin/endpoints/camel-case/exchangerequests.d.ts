...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    bulkExchangeRequestApi(
      ...
      options?: AdminRequestOptions<BulkExchangeRequestApiOutput['exchangerequests'][number]>,
    ...
    rejectAnExchangeRequestForMultipleItems(
      ...
      options?: AdminRequestOptions<RejectAnExchangeRequestForMultipleItemsOutput['exchangerequests'][number]>,
