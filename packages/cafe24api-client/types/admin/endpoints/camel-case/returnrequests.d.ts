...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    createAReturnRequestForMultipleItems(
      ...
      options?: AdminRequestOptions<CreateAReturnRequestForMultipleItemsOutput['returnrequests'][number]>,
    ...
    rejectAReturnRequestForMultipleItems(
      ...
      options?: AdminRequestOptions<RejectAReturnRequestForMultipleItemsOutput['returnrequests'][number]>,
