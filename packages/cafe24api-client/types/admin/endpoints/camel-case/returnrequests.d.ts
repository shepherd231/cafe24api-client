...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    createAReturnRequestForMultipleItems(
      ...
      options?: RequestOptions<CreateAReturnRequestForMultipleItemsOutput['returnrequests'][number]>,
    ...
    rejectAReturnRequestForMultipleItems(
      ...
      options?: RequestOptions<RejectAReturnRequestForMultipleItemsOutput['returnrequests'][number]>,
