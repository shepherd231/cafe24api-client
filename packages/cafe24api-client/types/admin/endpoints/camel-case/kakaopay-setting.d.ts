...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveSettingsForKakaopayOrders(
      ...
      options?: AdminRequestOptions<RetrieveSettingsForKakaopayOrdersOutput['kakaopay']>,
    ...
    updateSettingsForKakaopayOrders(
      ...
      options?: AdminRequestOptions<UpdateSettingsForKakaopayOrdersOutput['kakaopay']>,
