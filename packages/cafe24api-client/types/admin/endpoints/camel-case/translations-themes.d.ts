...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfThemeTranslations(
      ...
      options?: AdminRequestOptions<RetrieveAListOfThemeTranslationsOutput['themes'][number]>,
    ...
    retrieveAThemeTranslation(
      ...
      options?: AdminRequestOptions<RetrieveAThemeTranslationOutput['theme']>,
    ...
    updateAThemeTranslation(
      ...
      options?: AdminRequestOptions<UpdateAThemeTranslationOutput['theme']>,
