...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveACountOfAProductSProductTags(
      ...
      options?: AdminRequestOptions<RetrieveACountOfAProductSProductTagsOutput['count']>,
    ...
    retrieveAListOfAProductSProductTags(
      ...
      options?: AdminRequestOptions<RetrieveAListOfAProductSProductTagsOutput['tags']>,
