...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfActionLogs(
      ...
      options?: AdminRequestOptions<RetrieveAListOfActionLogsOutput['activitylogs'][number]>,
    ...
    retrieveAnActionLog(
      ...
      options?: AdminRequestOptions<RetrieveAnActionLogOutput['activitylog']>,
