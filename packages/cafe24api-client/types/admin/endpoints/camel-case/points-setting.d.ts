...
declare module 'cafe24api-client' {
  ...
  export interface RetrievePointsSettingsOutput {
    point: {
      shopNo: number;
      pointIssuanceStandard: Cafe24Enum;
      paymentPeriod: number;
      name: string;
      format: string;
      roundUnit: Cafe24Datetime;
      roundType: Cafe24Enum;
      displayType: string;
      unusablePointsChangeType: Cafe24Enum;
    };
  }
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrievePointsSettings(
      ...
      options?: AdminRequestOptions<RetrievePointsSettingsOutput['point']>,
    ...
    updatePointsSettings(
      ...
      options?: AdminRequestOptions<UpdatePointsSettingsOutput['point']>,
