...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfSupplierUsers(
      ...
      options?: RequestOptions<RetrieveAListOfSupplierUsersOutput['users'][number]>,
    ...
    retrieveACountOfSupplierUsers(
      ...
      options?: RequestOptions<RetrieveACountOfSupplierUsersOutput['count']>,
    ...
    retrieveSupplierUserDetails(
      ...
      options?: RequestOptions<RetrieveSupplierUserDetailsOutput['user']>,
    ...
    createASupplierUser(
      ...
      options?: RequestOptions<CreateASupplierUserOutput['user']>,
    ...
    updateASupplierUser(
      ...
      options?: RequestOptions<UpdateASupplierUserOutput['user']>,
    ...
    deleteASupplierUser(
      ...
      options?: RequestOptions<DeleteASupplierUserOutput['user']>,
