...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfRecipientsOfAnOrder(
      ...
      options?: AdminRequestOptions<RetrieveAListOfRecipientsOfAnOrderOutput['receivers'][number]>,
    ...
    updateOrderRecipients(
      ...
      options?: AdminRequestOptions<UpdateOrderRecipientsOutput['receivers'][number]>,
    ...
    changeShippingInformation(
      ...
      options?: AdminRequestOptions<ChangeShippingInformationOutput['receiver']>,
