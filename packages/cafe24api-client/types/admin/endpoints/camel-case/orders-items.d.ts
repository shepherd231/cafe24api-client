...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfOrderItems(
      ...
      options?: RequestOptions<RetrieveAListOfOrderItemsOutput['items'][number]>,
    ...
    createAnOrderItem(
      ...
      options?: RequestOptions<CreateAnOrderItemOutput['items'][number]>,
    ...
    updateAnOrderItem1(
      ...
      options?: RequestOptions<UpdateAnOrderItem1Output['item']>,
