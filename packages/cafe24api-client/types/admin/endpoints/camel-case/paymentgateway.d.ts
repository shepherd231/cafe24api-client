...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    createAPaymentGateway(
      ...
      options?: AdminRequestOptions<CreateAPaymentGatewayOutput['paymentgateway']>,
    ...
    updateAPaymentGateway(
      ...
      options?: AdminRequestOptions<UpdateAPaymentGatewayOutput['paymentgateway']>,
    ...
    deleteAPaymentGateway(
      ...
      options?: AdminRequestOptions<DeleteAPaymentGatewayOutput['paymentgateway']>,
