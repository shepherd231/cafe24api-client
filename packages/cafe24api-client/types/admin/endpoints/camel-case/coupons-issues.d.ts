...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfIssuedCoupons(
      ...
      options?: AdminRequestOptions<RetrieveAListOfIssuedCouponsOutput['issues'][number]>,
    ...
    createCouponIssuanceHistory(
      ...
      options?: AdminRequestOptions<CreateCouponIssuanceHistoryOutput['issues']>,
