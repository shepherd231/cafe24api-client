...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfShippingCarriers(
      ...
      options?: AdminRequestOptions<RetrieveAListOfShippingCarriersOutput['carriers'][number]>,
    ...
    retrieveAShippingCarrier(
      ...
      options?: AdminRequestOptions<RetrieveAShippingCarrierOutput['carrier']>,
    ...
    createAShippingCarrier(
      ...
      options?: AdminRequestOptions<CreateAShippingCarrierOutput['carrier']>,
    ...
    updateAShippingCarrier(
      ...
      options?: AdminRequestOptions<UpdateAShippingCarrierOutput['carrier']>,
    ...
    deleteAShippingCarrier(
      ...
      options?: AdminRequestOptions<DeleteAShippingCarrierOutput['carrier']>,
