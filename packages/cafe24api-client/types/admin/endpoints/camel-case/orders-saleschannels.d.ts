...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfSalesChannels(
      ...
      options?: AdminRequestOptions<RetrieveAListOfSalesChannelsOutput['saleschannels'][number]>,
    ...
    createASalesChannel(
      ...
      options?: AdminRequestOptions<CreateASalesChannelOutput['saleschannel']>,
    ...
    updateASalesChannel(
      ...
      options?: AdminRequestOptions<UpdateASalesChannelOutput['saleschannel']>,
    ...
    deleteASalesChannel(
      ...
      options?: AdminRequestOptions<DeleteASalesChannelOutput['saleschannel']>,
