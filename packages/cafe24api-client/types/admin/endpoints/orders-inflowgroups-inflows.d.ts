...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfGroupTrafficSources(
      ...
      options?: AdminRequestOptions<RetrieveAListOfGroupTrafficSourcesOutput['inflows'][number]>,
    ...
    createAGroupTrafficSource(
      ...
      options?: AdminRequestOptions<CreateAGroupTrafficSourceOutput['inflow']>,
    ...
    updateAGroupTrafficSource(
      ...
      options?: AdminRequestOptions<UpdateAGroupTrafficSourceOutput['inflow']>,
    ...
    deleteAGroupTrafficSource(
      ...
      options?: AdminRequestOptions<DeleteAGroupTrafficSourceOutput['inflow']>,
