...
declare module 'cafe24api-client' {
  ...
  export interface RetrieveAListOfCustomerInformationOutput {
    ...
    company_line: any;
    sns_list: string[];
    account_reactivation_date: Cafe24Datetime;
    }[];
  }
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfCustomerInformation(
      ...
      options?: AdminRequestOptions<RetrieveAListOfCustomerInformationOutput['customersprivacy'][number]>,
    ...
    retrieveACountOfCustomerInformation(
      ...
      options?: AdminRequestOptions<RetrieveACountOfCustomerInformationOutput['count']>,
    ...
    retrieveACustomerInformation(
      ...
      options?: AdminRequestOptions<RetrieveACustomerInformationOutput['customersprivacy']>,
    ...
    updateACustomerInformation(
      ...
      options?: AdminRequestOptions<UpdateACustomerInformationOutput['customersprivacy']>,
