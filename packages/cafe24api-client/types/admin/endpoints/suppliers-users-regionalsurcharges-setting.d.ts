...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveASupplierUserSRegionalShippingFeeSettings(
      ...
      options?: RequestOptions<RetrieveASupplierUserSRegionalShippingFeeSettingsInput>,
    ): Promise<
    ...
    updateASupplierUserSRegionalShippingFeeSettings(
      ...
      options?: RequestOptions<UpdateASupplierUserSRegionalShippingFeeSettingsInput>,
    ): Promise<
