...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveShippingFeeCancellationDetailsOfAnOrder(
      ...
      options?: AdminRequestOptions<RetrieveShippingFeeCancellationDetailsOfAnOrderOutput['shippingfeecancellation'][number]>,
    ...
    createAnOrderShippingFeeCancellation(
      ...
      options?: AdminRequestOptions<CreateAnOrderShippingFeeCancellationOutput['shippingfeecancellation']>,
