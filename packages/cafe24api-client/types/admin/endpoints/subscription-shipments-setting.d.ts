...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfSubscriptionProducts(
      ...
      options?: AdminRequestOptions<RetrieveAListOfSubscriptionProductsOutput['shipments'][number]>,
    ...
    createASubscriptionPaymentRule(
      ...
      options?: AdminRequestOptions<CreateASubscriptionPaymentRuleOutput['shipment']>,
    ...
    updateSubscriptionProducts(
      ...
      options?: AdminRequestOptions<UpdateSubscriptionProductsOutput['shipment']>,
    ...
    deleteSubscriptionProducts(
      ...
      options?: AdminRequestOptions<DeleteSubscriptionProductsOutput['shipment']>,
