...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfProductCategoryTranslations(
      ...
      options?: RequestOptions<RetrieveAListOfProductCategoryTranslationsOutput['categories'][number]>,
    ...
    updateProductCategoryTranslation(
      ...
      options?: RequestOptions<UpdateProductCategoryTranslationOutput['category']>,
