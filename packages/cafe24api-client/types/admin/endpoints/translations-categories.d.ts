...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfProductCategoryTranslations(
      ...
      options?: AdminRequestOptions<RetrieveAListOfProductCategoryTranslationsOutput['categories'][number]>,
    ...
    updateProductCategoryTranslation(
      ...
      options?: AdminRequestOptions<UpdateProductCategoryTranslationOutput['category']>,
