...
declare module 'cafe24api-client' {
  ...
  export interface Coupons {
    ...
    /**
      ...
      * 
      */ 
    issue_member_join_recommend: any;
    /**
      * @description
      * 회원가입시 쿠폰 발급 대상
      * 
    ...
    /**
      ...
      * 
      */ 
    issue_order_available_product: any;
    /**
      * @description
      * 발급 대상 카테고리
      * 
      ...
      * 
      */ 
    issue_order_available_category: any;
    /**
      * @description
      * 발급 조건 기념일 유형
      * 
    ...
    /**
      ...
      * 
      */ 
    issue_anniversary_pre_issue_day: any;
    /**
      * @description
      * 발급 조건 설치 모듈 유형
      * 
    ...
    /**
      ...
      * 
      */ 
    available_order_price_type: any;
    /**
      * @description
      * 사용가능 구매 금액
      * 
    ...
    /**
      ...
      * 
      */ 
    available_coupon_count_by_order: any;
    /**
      * @description
      * 시리얼 쿠폰 생성방법
      * 
    ...
    /**
      ...
      * 
      */ 
    use_notification_when_login: any;
    /**
      * @description
      * 쿠폰발급 SMS 발송 여부
      * 
  ...
  export interface RetrieveAListOfCouponsOutput {
    ...
    deleted: Cafe24Enum;
    is_stopped_issued_coupon: Cafe24Enum;
    pause_begin_datetime: any;
    pause_end_datetime: any;
    benefit_text: string;
    ...
    benefit_percentage_round_unit: Cafe24Datetime;
    benefit_percentage_max_price: string;
    include_regional_shipping_rate: any;
    include_foreign_delivery: any;
    coupon_direct_url: string;
    issue_type: Cafe24Enum;
    issue_sub_type: Cafe24Enum;
    issue_member_join: any;
    issue_member_join_recommend: any;
    issue_member_join_type: any;
    issue_order_amount_type: any;
    ...
    issue_order_amount_max: any;
    issue_order_path: any;
    issue_order_type: Cafe24Enum;
    issue_order_available_product: Cafe24Enum;
    issue_order_available_category: Cafe24Enum;
    issue_anniversary_type: any;
    issue_anniversary_pre_issue_day: any;
    issue_module_type: any;
    issue_review_count: any;
    ...
    issue_max_count_by_user: any;
    issue_count_per_once: any;
    issued_count: Cafe24Datetime;
    issue_member_group_no: any;
    issue_member_group_name: any;
    issue_no_purchase_period: any;
    issue_reserved: Cafe24Enum;
    issue_reserved_date: any;
    available_date: string;
    available_period_type: Cafe24Enum;
    available_begin_datetime: Cafe24Datetime;
    available_end_datetime: Cafe24Datetime;
    available_site: string;
    available_scope: Cafe24Enum;
    available_day_from_issued: any;
    available_price_type: Cafe24Enum;
    available_order_price_type: any;
    available_min_price: any;
    available_amount_type: Cafe24Enum;
    available_payment_method: string;
    available_product: Cafe24Enum;
    available_product_list: number[];
    available_category: Cafe24Enum;
    available_category_list: number[];
    available_coupon_count_by_order: number;
    serial_generate_method: any;
    coupon_image_type: Cafe24Enum;
    coupon_image_path: any;
    show_product_detail: any;
    use_notification_when_login: Cafe24Enum;
    send_sms_for_issue: Cafe24Enum;
    send_email_for_issue: any;
    }[];
  }
  ...
  export interface CreateACouponOutput {
    ...
    available_coupon_count_by_order: number;
    available_price_type: Cafe24Enum;
    available_order_price_type: Cafe24Enum;
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveACountOfCoupons(
      ...
      options?: AdminRequestOptions<RetrieveACountOfCouponsOutput['count']>,
    ...
    retrieveAListOfCoupons(
      ...
      options?: AdminRequestOptions<RetrieveAListOfCouponsOutput['coupons'][number]>,
    ...
    createACoupon(
      ...
      options?: AdminRequestOptions<CreateACouponOutput['coupon']>,
