...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfProductCategories(
      ...
      options?: AdminRequestOptions<RetrieveAListOfProductCategoriesOutput['categories'][number]>,
    ...
    retrieveACountOfProductCategories(
      ...
      options?: AdminRequestOptions<RetrieveACountOfProductCategoriesOutput['count']>,
    ...
    retrieveAProductCategory(
      ...
      options?: AdminRequestOptions<RetrieveAProductCategoryOutput['category']>,
    ...
    createAProductCategory(
      ...
      options?: AdminRequestOptions<CreateAProductCategoryOutput['category']>,
    ...
    updateAProductCategory(
      ...
      options?: AdminRequestOptions<UpdateAProductCategoryOutput['category']>,
    ...
    deleteAProductCategory(
      ...
      options?: AdminRequestOptions<DeleteAProductCategoryOutput['category']>,
