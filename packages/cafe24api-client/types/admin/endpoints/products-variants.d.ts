...
declare module 'cafe24api-client' {
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfProductVariants(
      ...
      options?: AdminRequestOptions<RetrieveAListOfProductVariantsOutput['variants'][number]>,
    ...
    updateMultipleProductVariants(
      ...
      options?: AdminRequestOptions<UpdateMultipleProductVariantsOutput['variants'][number]>,
