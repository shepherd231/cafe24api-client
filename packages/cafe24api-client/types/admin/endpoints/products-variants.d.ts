...
declare module 'cafe24api-client' {
  ...
  export interface ProductsVariants {
    ...
    /**
      ...
      * 
      */ 
    duplicated_custom_variant_code: any;
    /**
      * @description
      * 상품번호
      * 
  ...
  export interface UpdateAProductVariantOutput {
    ...
    custom_variant_code: string;
    duplicated_custom_variant_code: Cafe24Enum;
    display: Cafe24Enum;
    selling: Cafe24Enum;
    additional_amount: string;
    inventories: { 
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfProductVariants(
      ...
      options?: RequestOptions<RetrieveAListOfProductVariantsOutput['variants'][number]>,
    ...
    updateAProductVariant(
      ...
      options?: RequestOptions<UpdateAProductVariantOutput['variant']>,
    ...
    updateMultipleProductVariants(
      ...
      options?: RequestOptions<UpdateMultipleProductVariantsOutput['variants'][number]>,
    ...
    deleteAProductVariant(
      ...
      options?: RequestOptions<DeleteAProductVariantOutput['variant']>,
