...
declare module 'cafe24api-client' {
  ...
  export interface CreateAProductOutput {
    ...
    cloth_fabric: string;
    classification_code: string;
    additional_price: Cafe24Datetime;
    margin_rate: string;
    tax_calculation: Cafe24Enum;
    tax_type: Cafe24Enum;
    tax_rate: number;
  ...
  interface Cafe24AdminAPIClient {
    ...
    retrieveAListOfProducts(
      ...
      options?: AdminRequestOptions<RetrieveAListOfProductsOutput['products'][number]>,
    ...
    retrieveACountOfProducts(
      ...
      options?: AdminRequestOptions<RetrieveACountOfProductsOutput['count']>,
    ...
    retrieveAProductResource(
      ...
      options?: AdminRequestOptions<RetrieveAProductResourceOutput['product']>,
    ...
    createAProduct(
      ...
      options?: AdminRequestOptions<CreateAProductOutput['product']>,
    ...
    updateAProduct(
      ...
      options?: AdminRequestOptions<UpdateAProductOutput['product']>,
    ...
    deleteAProduct(
      ...
      options?: AdminRequestOptions<DeleteAProductOutput['product']>,
